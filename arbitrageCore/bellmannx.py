...
from arbitrageCore.misc import last_index_in_list
from arbitrageCore.single_exchange import load_exchange_graph
from arbitrageCore.logging_utils import FormatForLogAdapter
import logging
__all__ = [
...
async def find_opportunities_on_exchange(exchange_name, source='BTC', unique_paths=True, depth=False):
    ...
    return graph, bellman_ford(graph, source, unique_paths, depth)
